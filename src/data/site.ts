...
export const site = {
  ...
  pages: {
    home: {
      tagline: '10-20 minute domino games for all ages (5+)', // homepage <h1> — leave empty to hide it
    },
    contact: {
      title: 'Contact me',
  ...
  homepage: {
    notes: ['dominoes', 'wellsboro_comic_con'],
    games: ['domino_duel', 'memory', 'fish_pond', 'domino_kingdom', 'push_your_luck'],
  },
};
