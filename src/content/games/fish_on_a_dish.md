...
- To Draft a dish... draw 3 dishes from the top of the dish pile, keep one of them, putting it face-up in front of you.
...
- Take turns until 1 player has served 6 patrons (2 player), or 4 patrons (3 player).
- When a player serves a dish to 'end the game', some players might need to take 1 more turn so all players get the same number of turns. During this last round, players might be able to Serve two dishes with their 2 actions, thus jokers (either black or red (max. 4 pointers)) can be served, if no other customers are available.
