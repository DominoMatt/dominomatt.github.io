...
In most basic games the Heaviest double in all player's hands is set to start the round. If no doubles:

<ol type="a">
<li>All tiles are shuffled and re-dealt; or</li>
<li>Players take turns drawing one tile at a time until a double is found.</li>
</ol>
...
- If a player sheds their hand on their turn.
